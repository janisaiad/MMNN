...
- [Usage](#usage)
- [Frequency Benchmark Results](#frequency-benchmark-results)
- [Features](#features)
...
## Frequency Benchmark Results

We conducted a comprehensive frequency benchmark comparing low-rank MMNN (ranks 10, 15, 20, 25, 50, 100) with full-rank MLP (rank=777) on frequency-dependent functions. **Key finding: Low-rank MMNN significantly outperforms full-rank MLP**, with improvements ranging from **~1,000× to ~23,000×** depending on frequency.
...
**Best Low-Rank**: rank=25, fixWb=True → **6.68e-04** (1,185× better than full-rank)
...
**Best Low-Rank**: rank=100, fixWb=True → **3.40e-05** (22,930× better than full-rank)
...
**Best Low-Rank**: rank=100, fixWb=True → **1.50e-05**

### Key Insights

1. **Low-rank MMNN outperforms full-rank**: Best low-rank configurations achieve **1,000-23,000× better** error than full-rank (777)
2. **fixWb=True is critical**: Dramatically improves stability, especially at high frequencies
3. **Optimal rank depends on frequency**: Rank 20-25 for low frequencies, rank 100 for high frequencies
4. **Full-rank struggles**: Full-rank (777) fails catastrophically on frequency tasks, achieving errors ~0.4-0.8

For complete analysis, see [`experiments/table/FREQUENCY_BENCHMARK_COMPLETE_SUMMARY.md`](experiments/table/FREQUENCY_BENCHMARK_COMPLETE_SUMMARY.md)
