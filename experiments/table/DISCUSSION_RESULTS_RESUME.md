...
| **Log-ratio runs, epoch escape, scaling (batch/rank)** | See **`INDEX_LOGRATIO_ESCAPE_SCALING.md`** — plateau escape script, `epochs_to_escape_vs_lr.png` / `epochs_to_escape_vs_bs.png`, log-ratio tracking, and batch-size/rank scaling discussion (idea notes in `refs/ICLR/idea.md`; empirical sweep in baseline-sweep ranks docs). |
...
| Config name | Momentum | Final test error | Epochs |
|-------------|----------|------------------|--------|
| cos2pi_N1024_W1024_rank10_L2_SGD_mom0.0_AdaptiveStagnation | 0.0 | 1.2428e-04 | 250 |
| cos2pi_N1024_W1024_rank10_L2_SGD_mom0.3_AdaptiveStagnation | 0.3 | 2.1542e-06 | 250 |
| cos2pi_N1024_W1024_rank10_L2_SGD_mom0.6_AdaptiveStagnation | 0.6 | 3.0494e-06 | 250 |
| cos2pi_N1024_W1024_rank10_L2_SGD_mom0.7_AdaptiveStagnation | 0.7 | 1.9115e-06 | 250 |

Best: mom=0.7 (test 1.91e-06), then 0.3 and 0.6 (~2–3e-06); mom=0.0 is worse (1.24e-04). Total parameters 46101; lr_reduction_epochs e.g. [62, 129] for mom=0.7.
