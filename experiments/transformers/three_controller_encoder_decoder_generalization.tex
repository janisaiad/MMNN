...
which receives \(rS=8\) extra iterations but is not charged for attention or
QR, has risk \(4.7393\times10^{-8}\).  Thus the prompt-specific block
geometry improves arithmetic work by a factor \(2.62\) on this law.
