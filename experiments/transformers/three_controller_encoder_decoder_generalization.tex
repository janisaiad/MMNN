...
covering argument.  Adaptive HB, Chebyshev, and moment Chebyshev instead add
...
loop; learned-measure Chebyshev is the better fixed-polynomial option on a
clustered law; PCG remains the accuracy baseline when adaptive Krylov state is
allowed.
