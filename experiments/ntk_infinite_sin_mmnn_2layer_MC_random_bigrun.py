...
pathlib.Path("figures/ntk_infinite_sin_mmnn_2layer_MC_random_bigrun").mkdir(parents=True, exist_ok=True)
pathlib.Path("data/ntk_infinite_sin_mmnn_2layer_MC_random_bigrun").mkdir(parents=True, exist_ok=True)
                    ...
                    for sigma_A in sigma_As:
                        for sigma_c in sigma_cs:
                            try:
                                ...
                                plt.tight_layout()
                                plt.savefig(f'figures/ntk_infinite_sin_mmnn_2layer_MC_random_bigrun/dist_dim{input_dim}_n{n_samples}_beta{beta}_rank{rank}.png')
                                plt.close()
                                ...
                                plt.savefig(f'figures/ntk_infinite_sin_mmnn_2layer_MC_random_bigrun/mean_ntk_dim{input_dim}_n{n_samples}_beta{beta}_rank{rank}.png')
                                plt.close()

                                # we save arrays
                                jnp.save(f'data/ntk_infinite_sin_mmnn_2layer_MC_random_bigrun/ntk_samples_dim{input_dim}_n{n_samples}_beta{beta}_rank{rank}.npy', 
                                        ntk_samples)
                                jnp.save(f'data/ntk_infinite_sin_mmnn_2layer_MC_random_bigrun/mean_ntk_dim{input_dim}_n{n_samples}_beta{beta}_rank{rank}.npy',
                                        mean_ntk)
                                jnp.save(f'data/ntk_infinite_sin_mmnn_2layer_MC_random_bigrun/eigenvals_dim{input_dim}_n{n_samples}_beta{beta}_rank{rank}.npy',
...
jnp.save('data/ntk_infinite_sin_mmnn_2layer_MC_random_bigrun/all_results.npy', results)
...
for config_key in results:
    ...
    plt.grid(True)
    plt.savefig(f'figures/ntk_infinite_sin_mmnn_2layer_MC_random_bigrun/loss_summary_{config_key}.png')
    plt.close()
