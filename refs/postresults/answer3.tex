% PDF / LuaLaTeX: compile via answer3-compiled.tex (\input{answer3.tex}).
% OpenReview rebuttal editor uses Markdown + MathJax, not raw LaTeX layout commands.
% Paste the Markdown version from answer3-openreview.md (no \medskip, \textbf, ~, \url).
