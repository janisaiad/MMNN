...
\begin{itemize}
  ...
  \item \textbf{Variance over frozen features.} We will add variance analysis over different draws of frozen random features (finite width).
  ...
  \item \textbf{Sensitivity to frozen draw.} The theory assumes bounded mixing; performance at finite width can vary with the frozen draw. We will quantify this variance empirically and clarify which parts of the theory depend on boundedness vs.\ are mean-field heuristics.
\end{itemize}
