...
More precisely, there is no technical novelty for the existence/uniqueness proof following Nguyen et al. The only technical novelty comes from modifying the coupling template to our channel-wise sum (their three-layer assumption / coupling display): after introducing the coupling $\pi\_t$ and using bounded first-layer activation, one obtains a bound of the form
