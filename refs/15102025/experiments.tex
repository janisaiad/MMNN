...
\begin{itemize}
    ...
    \item \textbf{Dictionary-learning behavior:} consistent with theory, MMNNs exhibit component-wise specialization and low-rank structure consistent with dictionary learning: a small subset of active components aligns with salient target features early, while remaining components refine residuals during descent.\\
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{loss_evolution.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{loss_std_evolution.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{error_evolution.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{ntk_eigenvalues_minmax.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{ntk_first_last_eigenvalues.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{final_prediction.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{layer_0_components.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{layer_1_components.png}
