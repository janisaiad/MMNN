...
By Fisher's CLT~\cite{fisher1915probable,hotelling1953new}, \( \sqrt{r}(\hat{\rho}_r - \rho) \xrightarrow{d} \mathcal{N}(0, (1-\rho^2)^2) \). For large \( r \), using sub-Gaussian concentration:
\[
...
For the hypergeometric function near its argument \( 1 - (t+v)/2 \to 1^- \), we use the connection formula and asymptotic expansion from \cite{nist_dlmf} and \cite{abramowitz1964handbook}:
\[
