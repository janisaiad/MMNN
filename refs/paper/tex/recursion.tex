...
We can now characterize the statistical properties of the empirical correlation and norms. By rotational invariance, the empirical correlation and squared norms follow Fisher–Kibble decoupling:
\[
...
\[
p(\rho_1 \mid \rho, r) = \frac{(r-2)\,\Gamma(r-1)\,(1-\rho^2)^{\frac{r-1}{2}}\,(1-\rho_1^2)^{\frac{r-4}{2}}}{\sqrt{2\pi}\,\Gamma(r-\tfrac{1}{2})\,(1-\rho\rho_1)^{r-\frac{3}{2}}}\,{}_2F_1\!\left(\tfrac{1}{2},\tfrac{1}{2};\, r-\tfrac{1}{2};\, \tfrac{1+\rho\rho_1}{2}\right),
\]
for \( r > 2 \). For large \( r \), the inverse Gudermann function applied to the complementary angle follows a normal distribution:
\[
\boxed{ \text{gd}^{-1}\!\left(\frac{\pi}{2} - \arccos(\rho_1)\right) \;\approx\; \mathcal{N}\!\left(\text{arctanh}(\rho),\; \frac{1}{r-3}\right) }
\]
