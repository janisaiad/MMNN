...
\centering
\includegraphics[width=\linewidth]{../../data/feynman/powerlaw_early_stopping/spectral_eigenvector_mixing.pdf}
\end{minipage}
\hfill
\begin{minipage}{0.49\linewidth}
\centering
\includegraphics[width=\linewidth]{../../data/feynman/powerlaw_early_stopping/weingarten_risk_distribution.pdf}
\end{minipage}
...
\begin{minipage}{0.49\linewidth}
\centering
\includegraphics[width=\linewidth]{../../data/feynman/powerlaw_early_stopping/minimum_risk_data_scaling.pdf}
\end{minipage}
\hfill
\begin{minipage}{0.49\linewidth}
\centering
\includegraphics[width=\linewidth]{../../data/feynman/powerlaw_early_stopping/optimal_stopping_data_scaling.pdf}
\end{minipage}
